package crc641eca0bd4abe1b4e0;


public class LevelPagerAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("RushHour_project.Adapters.LevelPagerAdapter, RushHour_project", LevelPagerAdapter.class, __md_methods);
	}


	public LevelPagerAdapter ()
	{
		super ();
		if (getClass () == LevelPagerAdapter.class)
			mono.android.TypeManager.Activate ("RushHour_project.Adapters.LevelPagerAdapter, RushHour_project", "", this, new java.lang.Object[] {  });
	}
